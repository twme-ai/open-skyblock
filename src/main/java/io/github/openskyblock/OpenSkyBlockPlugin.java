...
public final class OpenSkyBlockPlugin extends JavaPlugin {
    ...
    private TrophyFishService trophyFishService;
    ...
    public void onEnable() {
        ...
        this.skillService.gardenService(gardenService);
        this.skillService.dragonService(dragonService);
        this.skillService.riftService(riftService);
        ...
        this.statService.mayorService(mayorService);
        ...
        this.seaCreatureService = new SeaCreatureService(configService, textService, profileManager, skillService, statService, mobService);
        ...
        this.minionService = new MinionService(this, configService, textService, profileManager, collectionService, upgradeService, customItemService);
    ...
    private void reloadServices() {
        ...
        gardenService.reload();
        dragonService.reload();
        riftService.reload();
    ...
    public GardenService garden() {
        return gardenService;
    }

    public DragonService dragons() {
        return dragonService;
    }

    public RiftService rift() {
        return riftService;
    }

    public KuudraService kuudra() {
        return kuudraService;
    }
    ...
    public TrophyFishService trophyFish() {
        return trophyFishService;
    }
