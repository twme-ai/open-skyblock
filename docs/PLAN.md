...
3. Menus and Recipes
   - Configurable SkyBlock menu, profile viewer, paged recipe book, paged collection menu, bank menu, and minion UI are implemented.
   - Skill menu remains future work beyond command summaries.
