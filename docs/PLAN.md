...
3. Menus and Recipes
   - Configurable SkyBlock menu, profile viewer, skill menu, paged recipe book, paged collection menu, bank menu, and minion UI are implemented.
