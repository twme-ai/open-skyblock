...
4. Stats and Combat
   ...
   - Vanilla/SkyBlock-specific enchantment effects, essence currencies, dungeon-only star scaling, advanced potion modifiers, and advanced ability scripting remain future work.
