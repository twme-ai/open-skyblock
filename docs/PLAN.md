...
2. Private Islands
   - World allocation, configurable world border, spawn, saved island home, visitor access toggles, island visiting, basic co-op invites/members, island management UI, and protected interaction rules are implemented.
   - Island border, reset flow, fully shared cooperative profiles, deeper permissions, warps, and schematic placement remain future work.
