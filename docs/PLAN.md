...
1. Foundation
   ...
   - Minion definitions, placeable minion items, persisted locations, generated storage, configurable fuel, configurable upgrade slots, compactor-style output conversion, offline ticking, claim menus, and pickup flow.
...
2. Private Islands
   ...
   - Minion placement blocks, configurable fuel, configurable upgrade slots, compactor-style output conversion, generated storage, offline generation, and collection credit are implemented; external storage chests, automated selling, and skins remain future work.
