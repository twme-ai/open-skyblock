...
4. Stats and Combat
   ...
   - Configurable Essence balances and item stars with item metadata persistence, category limits, purse/Essence costs, display suffix/lore, and item stat scaling are implemented.
   ...
   - Vanilla/SkyBlock-specific enchantment effects, Essence salvage/acquisition loops, dungeon-only star scaling, advanced potion modifiers, and advanced ability scripting remain future work.
