...
2. Private Islands
   - World allocation, spawn, visitor access toggles, island visiting, island management UI, and protected interaction rules are implemented.
   - Island border, reset flow, cooperative profiles, deeper permissions, warps, and schematic placement remain future work.
