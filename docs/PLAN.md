...
5. Economy
   ...
   - Configurable persistent Auction House BIN and bid listings with listing fees, bid escrow/refunds, direct buy/bid flow, cancellation rules, expired item returns, and seller/winner claim flow are implemented.
   ...
   - Auction House and Bazaar GUI browsing, trade GUI polish, deeper escrow/claim queues, taxes, anti-duplication checks, market analytics, and audit logging remain future work.
