...
1. Foundation
   ...
   - Minion definitions, placeable minion items, persisted locations, generated storage, configurable fuel, offline ticking, claim menus, and pickup flow.
...
2. Private Islands
   ...
   - Minion placement blocks, configurable fuel, generated storage, offline generation, and collection credit are implemented; compactors, storage chests, automated selling, skins, and upgrade slots remain future work.
