...
2. Private Islands
   - World allocation, spawn, visitor access toggles, island visiting, basic co-op invites/members, island management UI, and protected interaction rules are implemented.
