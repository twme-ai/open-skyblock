...
4. Stats and Combat
   ...
   - Configurable item enchantments with item metadata persistence, max levels, ultimate-enchantment exclusivity, purse costs, Enchanting Table GUI, and stat/lore integration are implemented.
   ...
   - Vanilla/SkyBlock-specific enchantment effects, enchanting anvil UI, essence currencies, dungeon-only star scaling, advanced potion modifiers, and advanced ability scripting remain future work.
