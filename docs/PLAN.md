...
2. Private Islands
   - World allocation, configurable world border, spawn, saved island home, guarded reset flow, visitor access toggles, island visiting, basic co-op invites/members, island management UI, and protected interaction rules are implemented.
   - Fully shared cooperative profiles, deeper permissions, warps, and schematic placement remain future work.
