...
- Configurable pets with persistent ownership, active pet selection, XP/level tracking, GUI activation, attachable pet items, Pet Score rewards, and active pet stat aggregation.
