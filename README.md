...
- Configurable item enchantments with persistent item metadata, max levels, ultimate-enchantment exclusivity, purse costs, Enchanting Table GUI, lore rendering, and stat aggregation.
