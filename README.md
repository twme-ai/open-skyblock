...
- `/skyblock island pads`
- `/skyblock island pad give`
- `/skyblock island pad link <pad> <group>`
...
- `/skyblock island coop roles`
- `/skyblock island coop role <player> <role>`
- `/skyblock island coop perms [role]`
- `/skyblock bank`
